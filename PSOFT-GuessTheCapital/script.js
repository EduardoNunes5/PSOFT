...
function startGame(){
	fetch("raw.githubusercontent.com/EduardoNunes5/PSOFT/master/PSOFT-GuessTheCapital/estados.json")
...
function checkAnswer(){
	...
	if($input.value.toLowerCase() === currentState[1].capital.toLowerCase()){
